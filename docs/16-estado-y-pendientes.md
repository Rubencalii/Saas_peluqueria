...
- ✅ **Entradas y salidas de efectivo** (migración `0031_movimientos_caja.sql`): el arqueo solo contaba ingresos, así que un cajón real nunca cuadraba (falta el fondo de cambio con el que se abre y sobran los pagos en metálico del día). Se apuntan por sede y día natural desde la propia pantalla de Caja, con concepto y quién lo apuntó, y mueven el efectivo esperado.
