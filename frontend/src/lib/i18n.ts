...
const ES: Dict = {
  ...
  "rate.title": "Valora tu visita",
  "rate.subtitle": "Tu opinión ayuda a {loc} a seguir mejorando.",
  "rate.notFound": "No encontramos esta cita. Abre el enlace completo del mensaje.",
  "rate.notCompleted": "Podrás valorar tu cita cuando ya se haya realizado.",
  "rate.already": "Esta cita ya tiene una valoración. ¡Gracias!",
  "rate.commentLabel": "¿Algo que contarnos? (opcional)",
  "rate.submit": "Enviar valoración",
  "rate.sending": "Enviando…",
  "rate.error": "No se pudo enviar la valoración.",
  "rate.thanks": "¡Gracias por tu valoración!",
  "rate.thanksSub": "Nos ayuda muchísimo a mejorar. 💛",
  "rate.google": "¿Nos la dejas también en Google? Ayuda a que más gente nos encuentre.",
  "rate.googleBtn": "⭐ Dejar reseña en Google",
  "rate.back": "Volver al inicio",
...
const CA: Dict = {
  ...
  "rate.title": "Valora la teva visita",
  "rate.subtitle": "La teva opinió ajuda {loc} a seguir millorant.",
  "rate.notFound": "No trobem aquesta cita. Obre l'enllaç complet del missatge.",
  "rate.notCompleted": "Podràs valorar la cita quan ja s'hagi fet.",
  "rate.already": "Aquesta cita ja té una valoració. Gràcies!",
  "rate.commentLabel": "Res a explicar-nos? (opcional)",
  "rate.submit": "Enviar valoració",
  "rate.sending": "Enviant…",
  "rate.error": "No s'ha pogut enviar la valoració.",
  "rate.thanks": "Gràcies per la teva valoració!",
  "rate.thanksSub": "Ens ajuda moltíssim a millorar. 💛",
  "rate.google": "Ens la deixes també a Google? Ajuda que més gent ens trobi.",
  "rate.googleBtn": "⭐ Deixar ressenya a Google",
  "rate.back": "Tornar a l'inici",
...
const EN: Dict = {
  ...
  "rate.title": "Rate your visit",
  "rate.subtitle": "Your feedback helps {loc} keep improving.",
  "rate.notFound": "We couldn't find this appointment. Open the full link from the message.",
  "rate.notCompleted": "You'll be able to rate your appointment once it has taken place.",
  "rate.already": "This appointment already has a review. Thank you!",
  "rate.commentLabel": "Anything to tell us? (optional)",
  "rate.submit": "Send review",
  "rate.sending": "Sending…",
  "rate.error": "The review could not be sent.",
  "rate.thanks": "Thanks for your review!",
  "rate.thanksSub": "It helps us improve a lot. 💛",
  "rate.google": "Would you leave it on Google too? It helps more people find us.",
  "rate.googleBtn": "⭐ Leave a Google review",
  "rate.back": "Back to home",
